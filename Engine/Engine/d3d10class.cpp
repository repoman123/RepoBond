						  ...
						  float screenDepth, float screenNear)
{
	...
	////D3DXMatrixOrthoOffCenterLH(&m_orthoMatrix,0,screenWidth,0,screenHeight,screenNear,screenDepth);
...
void D3DClass::TogleFullScreen()
{
	...
	{
		fullScreen=true;
		this->m_swapChain->SetFullscreenState(true,NULL);
	}
}